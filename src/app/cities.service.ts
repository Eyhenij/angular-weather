...
export class CitiesService {
    ...
    // private weatherUrl = `https://dark-sky.p.rapidapi.com/${latitude},${longitude}?lang=en&units=auto`;
    private httpOptions = {
    ...
    getWeatherData(latitude: number, longitude: number): Observable<any>{
        // return this.http.get<any>(`https://dark-sky.p.rapidapi.com/%7B${latitude}%7D,%7B${longitude}%7D`);
        return this.http.get<any>(
            `https://dark-sky.p.rapidapi.com/${latitude},${longitude}?lang=en&units=auto`,
            this.httpOptions
        );
    }
